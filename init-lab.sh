...
JDG_HOME=./target/jboss-datagrid-6.3.1-server
JDG_ONE_HOME=./target/jboss-datagrid-6.3.1-server-one
JDG_TWO_HOME=./target/jboss-datagrid-6.3.1-server-two
SERVER_DIR=$JBOSS_HOME/standalone/deployments/
SERVER_CONF=$JBOSS_HOME/standalone/configuration/
SRC_DIR=./installs
EAP_SERVER=jboss-eap-6.3.0.zip
EAP_SERVER_MD5SUM=
JDG_SERVER=jboss-datagrid-6.3.1-server.zip
JDG_LIBRARY_MODUELS=jboss-datagrid-6.3.1-eap-modules-library.zip
HOTROD_MODULES=jboss-datagrid-6.3.1-eap-modules-hotrod-java-client.zip
...
function setup_eap_with_modules() {
	...
	cp -R ${tmpdir}/jboss-datagrid-6.3.1-eap-modules-library/modules/* $JBOSS_HOME/modules/
	rm -rf  ${tmpdir} 
	...
	#cp -R ${tmpdir}/jboss-datagrid-6.3.1-eap-modules-hotrod-java-client/modules/* $JBOSS_HOME/modules/
	#rm -rf  ${tmpdir}  
