...
REPOS=(jboss-eap-6.3.0-maven-repository.zip jboss-datagrid-6.3.1-maven-repository.zip)
EAP_MVN_REPO=jboss-eap-6.3.0-maven-repository.zip
JDG_SERVER=jboss-datagrid-6.3.1-server.zip
JDG_MVN_REPO=jboss-datagrid-6.3.1-maven-repository.zip
...
pushd $MVN_REPO/jboss-datagrid-6.3.1-maven-repository > /dev/null
